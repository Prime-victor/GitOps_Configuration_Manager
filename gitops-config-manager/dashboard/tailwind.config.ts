    ...
    extend: {
      ...
      colors: {
        ...
        status: {
          ...
          "progressing-bg": "hsl(var(--status-progressing-bg))",
          degraded: "hsl(var(--status-degraded))",
          "degraded-bg": "hsl(var(--status-degraded-bg))",
          synced: "hsl(var(--status-synced))",
          "synced-bg": "hsl(var(--status-synced-bg))",
          outofsync: "hsl(var(--status-outofsync))",
          "outofsync-bg": "hsl(var(--status-outofsync-bg))",
